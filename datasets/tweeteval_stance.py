...
_DESCRIPTION = """\
StanceEval (Mohammad et al. 2016) involves determining if the author of a piece of text has a favorable, neutral, or negative position towards a proposition or target.
"""
...
class TweetevalStance_Dataset(datasets.GeneratorBasedBuilder):
    """The StanceEval dataset for Stance Detection task."""

    VERSION = datasets.Version("1.0.0")

    DEFAULT_CONFIG_NAME = "tweeteval_stance"
    LABEL_NAMES = [
        "against",
        "favor",
        "none"
