...
_DESCRIPTION = """\
EmotionEval (Mohammad et al. 2018) involves detecting the emotion evoked by a tweet and is based on the Af- fects in Tweets conducted during SemEval-2018. Following Barbieri et al. (2020), the most common four emotions (i.e., anger, joy, sadness, and optimism) are selected as the label sets.
"""
...
class TweetevalEmotion_Dataset(datasets.GeneratorBasedBuilder):
    """The EmotionEval dataset for Social Emotion Detection task."""

    VERSION = datasets.Version("1.0.0")

    DEFAULT_CONFIG_NAME = "tweeteval_emotion"
    LABEL_NAMES = [
        "anger",
        "sadness",
        "joy",
