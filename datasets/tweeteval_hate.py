...
_DESCRIPTION = """\
HatEval (Basile et al. 2019) stems from SemEval-2019 Hateval challenge and is used to predict whether a tweet is hateful towards immigrants or women.
"""
...
class TweetevalHate_Dataset(datasets.GeneratorBasedBuilder):
    """The HatEval dataset for Hate Speech Detection task."""

    VERSION = datasets.Version("1.0.0")

    DEFAULT_CONFIG_NAME = "tweeteval_hate"
    LABEL_NAMES = [
        "not-hate",
        "hate"
    ]
