...
_DESCRIPTION = """\
IronyEval (Hee, Lefever, and Hoste 2018) is from SemEval-2018 Irony Detection and consists of identifying whether a tweet includes ironic intents or not.
"""
...
class TweetevalIrony_Dataset(datasets.GeneratorBasedBuilder):
    """The IronyEval dataset for Irony Detection task."""

    VERSION = datasets.Version("1.0.0")

    DEFAULT_CONFIG_NAME = "tweeteval_irony"
    LABEL_NAMES = [
        "non_irony",
        "irony"
    ]
